    ...
    <main className="bg-white">
      ...
      <section className="relative w-full py-8 md:py-20 bg-gradient-to-r from-gray-700 via-blue-600 to-gray-700 text-white px-4 -mt-16">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            Baba Adhesive is a leading supplier of high-performance adhesives for construction, furniture, and industrial applications. Our products are formulated with superior bonding strength and reliability.
          </motion.p>
        </div>
      </section>
