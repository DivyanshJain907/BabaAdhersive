...
export default function QuotePage() {
  ...
  return (
    <main className="bg-white">
      ...
      {/* Hero Section */}
      <section className="relative w-full py-8 md:py-20 bg-gradient-to-r from-gray-700 via-blue-600 to-gray-700 text-white px-4 -mt-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Request a personalized quote for our premium adhesive products
          </motion.p>
        </div>
      </section>
            ...
            <form onSubmit={handleSubmit} className="space-y-3 md:space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 md:px-4 md:py-3 text-sm bg-white text-darkGray placeholder-gray-400 rounded border border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-600 outline-none transition"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-3 py-2 md:px-4 md:py-3 text-sm bg-white text-darkGray rounded border border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-600 outline-none transition"
                  >
                    <option value="">Select a product</option>
                    <option value="Panel Fixing Adhesive">Panel Fixing Adhesive</option>
                    <option value="Furniture Adhesive">Furniture Adhesive</option>
                    <option value="Industrial Glue">Industrial Glue</option>
                    <option value="Waterproof Adhesive">Waterproof Adhesive</option>
                    <option value="Laminate Bonding Solution">Laminate Bonding Solution</option>
                    <option value="Woodworking Adhesive">Woodworking Adhesive</option>
                ...
                {/* Quantity */}
                <div>
                  <label className="block text-xs md:text-sm font-medium text-darkGray mb-2\">Quantity *</label>
                  <input
                    type="number"
                    name="quantity"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Enter quality, size, or any specific requirements"
                  rows={3}
                  className="w-full px-3 py-2 md:px-4 md:py-3 text-sm bg-white text-darkGray placeholder-gray-400 rounded border border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-600 outline-none transition resize-none"
                />
              </div>
              ...
              <motion.button
                ...
                type="submit"
                disabled={loading}
                  className="w-full bg-blue-600 text-white py-2 md:py-3 text-sm md:text-base rounded font-bold hover:bg-blue-700 transition disabled:opacity-50"
              >
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                { title: 'Quality Assured', description: 'Premium quality adhesive products' },
              ].map((item, index) => (
