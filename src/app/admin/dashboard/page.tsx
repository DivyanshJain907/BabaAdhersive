    ...
    <div className="min-h-screen bg-white">
      ...
      <motion.header className="bg-white border-b border-gray-200 sticky top-0 z-40 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-3 md:py-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
          <h1 className="text-lg md:text-2xl font-bold text-black">Baba Adhesive Admin Dashboard</h1>
          <div className="flex gap-2 md:gap-4 w-full md:w-auto">
            <button
              onClick={() => router.push('/')}
              className="flex-1 md:flex-none bg-blue-600 text-white px-4 md:px-6 py-2 rounded hover:bg-blue-700 transition text-sm md:text-base"
            >
              Landing Page
            </button>
            <button
        ...
        >
          ...
          <form onSubmit={handleAddProduct} className="grid grid-cols-2 gap-4">
            ...
            <input
              ...
              required
              className="px-4 py-3 bg-white text-darkGray rounded border border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-600 outline-none transition"
            />
            ...
            <textarea
              ...
              required
              className="col-span-2 px-4 py-3 bg-white text-darkGray rounded border border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-600 outline-none transition resize-none"
              rows={3}
            />
            ...
            <button
              type="submit"
              className="col-span-2 bg-blue-600 text-white py-3 rounded font-bold hover:bg-blue-700 transition"
            >
            ...
            >
              ...
              <div className="flex gap-2 flex-shrink-0">
                <button
                  ...
                  className="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 transition font-semibold text-sm whitespace-nowrap"
                >
                  Edit
                </button>
                <button
    ...
    <div>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 md:mb-8 gap-3">
        ...
        <motion.button
          ...
          className="w-full md:w-auto bg-blue-600 text-white px-4 md:px-6 py-2 md:py-3 rounded font-bold text-sm md:text-base"
        >
        ...
        >
          ...
          <form onSubmit={handleAddEntry} className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
            <input
              ...
              required
              className="col-span-1 md:col-span-2 px-3 md:px-4 py-2 md:py-3 bg-white text-darkGray rounded border border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-600 outline-none transition text-sm md:text-base"
            />
            ...
            <input
              ...
              required
              className="px-3 md:px-4 py-2 md:py-3 bg-white text-darkGray rounded border border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-600 outline-none transition text-sm md:text-base"
            />
            ...
            <button
              type="submit"
              className="col-span-1 md:col-span-2 bg-blue-600 text-white py-2 md:py-3 rounded font-bold hover:bg-blue-700 transition text-sm md:text-base"
            >
              ...
              <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-3 md:gap-4">
                <div className="flex-1 min-w-0">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                    <span className="text-blue-600 font-bold text-base md:text-lg">{entry.year}</span>
                ...
                <div className="flex gap-2 flex-shrink-0 w-full md:w-auto">
                  <button
                    ...
                    className="flex-1 md:flex-none bg-blue-600 text-white px-4 md:px-6 py-2 rounded hover:bg-blue-700 transition font-semibold text-xs md:text-sm whitespace-nowrap"
                  >
                    Edit
                  </button>
                  <button
