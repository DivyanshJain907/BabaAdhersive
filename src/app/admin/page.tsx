          ...
          <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 md:py-3 bg-white text-darkGray placeholder-gray-400 rounded border border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-600 outline-none transition text-sm md:text-base"
              />
            </div>
            ...
            {error && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="bg-blue-50 border border-blue-200 text-blue-700 p-3 rounded text-xs md:text-sm"
              >
                {error}
              </motion.div>
            )}
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 text-white py-2 md:py-3 rounded font-bold hover:bg-blue-700 transition disabled:opacity-50 text-sm md:text-base"
            >
