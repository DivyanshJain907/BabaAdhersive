        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4">
          <div className="relative w-full overflow-hidden">
            ...
            <button
              ...
              className="absolute left-0 top-1/2 transform -translate-y-1/2 z-20 bg-blue-600 hover:bg-blue-700 text-white rounded-full p-2 md:p-3 transition shadow-lg hover:shadow-xl"
            ...
            <button
              ...
              className="absolute right-0 top-1/2 transform -translate-y-1/2 z-20 bg-blue-600 hover:bg-blue-700 text-white rounded-full p-2 md:p-3 transition shadow-lg hover:shadow-xl"
